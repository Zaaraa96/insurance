<template>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <section class="conditions box-card">
            ...
            <a href="/assets/conditions.pdf" download="" class="dl">
                <section class="right">
                    <div class="icon-box">

                    </div>
                    <h2>دانلود متن شرایط قرارداد</h2>
                </section>
                <section class="left">
                </section>
            </a>
          ...
          <a id="register-btn" @click="submit">
            ...
            <g id="Layer_2" data-name="Layer 2">
              <g id="Layer_1-2" data-name="Layer 1">
                <path class="cls-1" d="M572,0H20A20,20,0,0,0,0,20V76A20,20,0,0,0,20,96H572a20,20,0,0,0,20-20V20A20,20,0,0,0,572,0Z"></path>
                <path class="cls-2" d="M173.68,96H20A20,20,0,0,1,0,76V30.28C60.18,34.82,125.76,64.17,173.68,96Z"></path>
                <path class="cls-3" d="M592,20V32C578.27,14.77,558.57,6.15,534.54,6.47c-39.69.53-62.76,19.06-92.09,38.09-33.72,21.94-109,57.7-161.95-10A146.24,146.24,0,0,1,260.28,0H572A20,20,0,0,1,592,20Z"></path>
              </g></g></svg>
        </a>
...
export default {
  ...
  methods: {
    changeSubmit(){
      ...
      let c2= document.getElementsByClassName("cls-2");
      let c3= document.getElementsByClassName("cls-3");
